...
begin
    ...
    begin
        ...
        { Buscar los dos tanques con mayor volumen }
        ...
        { Cantidad de tanques con alto menor a 1.40 }
        if alto < 1.40 then
            cantidadAltos := cantidadAltos + 1;

        { Cantidad de tanques con volumen menor a 800 }
        if volumen < 800 then
    ...
    writeln('Volumen del tanque mayor: ',
            mayor1:0:2, ' m3');

    writeln('Volumen del segundo tanque mayor: ',
            mayor2:0:2, ' m3');

    if cantidadCilindricos > 0 then
        writeln('Volumen promedio de los tanques cilindricos: ',
                (sumaCilindricos / cantidadCilindricos):0:2, ' m3')
    else
        writeln('No se vendieron tanques cilindricos.');

    if cantidadRectangulares > 0 then
        writeln('Volumen promedio de los tanques rectangulares: ',
                (sumaRectangulares / cantidadRectangulares):0:2, ' m3')
    else
        writeln('No se vendieron tanques rectangulares.');

    writeln('Cantidad de tanques con alto menor a 1.40 m: ',
            cantidadAltos);

    writeln('Cantidad de tanques con volumen menor a 800 m3: ',
            cantidadVolumen);
